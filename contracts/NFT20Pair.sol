...
//+-This is the Smart Contract that allows us to Divide an N.F.T. into "Stocks" ERC-20:_
...
contract NFT20Pair is ERC20, IERC721Receiver, ERC1155Receiver {
    ...
    //+-The Function of the N.F.T. FlashLoan Itself:_
    function flashLoan(
        uint256[] calldata _ids, //+-I.D.s of the N.F.T.s that you want to Borrow.
        uint256[] calldata _amounts, //+-For ERC-1155 N.F.T.s, the amount of the same repeated ERC-1155 N.F.T. that you want.
        address _operator, //+-The Receiver of the Loan.
        bytes calldata _params //+-Optional Data that can be added.
    ) external flashloansEnabled() {
        require(_ids.length < 80, "You can only Borrow 80 N.F.T.s at a time.");
